...
const defaultColumns: GridColDef[] = [
  {
    ...
    renderCell: ({ row }: CellType) => (
      <Typography component={LinkStyled} href={`/admin/order/preview/${row.id}`}>{`#${row.id}`}</Typography>
    )
  },
  {
    flex: 0.1,
        ...
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          ...
          <Tooltip title='View'>
            <IconButton
              ...
              href={`/admin/order/preview/${row.id}`}
            >
          ...
          <OptionsMenu
            ...
            options={[
              ...
              {
                text: 'Print',
                href: `/admin/order/print/${row.id}`,
                icon: <Icon icon='tabler:download' fontSize={20} />
              },
              {
                text: 'Edit',
                href: `/admin/order/edit/${row.id}`,
