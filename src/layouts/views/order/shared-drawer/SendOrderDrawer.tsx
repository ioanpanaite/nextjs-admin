...
const SendOrderDrawer = ({ open, toggle }: Props) => {
  return (
    <Drawer
      open={open}
      anchor='right'
    ...
    >
      ...
      <Box sx={{ p: theme => theme.spacing(0, 6, 6) }}>
        ...
        <CustomTextField
          ...
          sx={{ mb: 5 }}
          variant='outlined'
          placeholder='Order regarding goods'
          defaultValue='Order of purchased Admin Templates'
        />
        <CustomTextField
          rows={10}
          fullWidth
...
We have generated a new order in the amount of $95.59

We would appreciate payment of this order by 05/11/2019`}
        />
        <Box sx={{ mb: 6 }}>
          <CustomChip
            rounded
...
export default SendOrderDrawer
