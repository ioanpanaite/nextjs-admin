        ...
        return (
          ...
          >
                ...
                >
                  ...
                  >
                    {selectedChat.contact?.image ? (
                      ...
                      >
                        {selectedChat.contact?.fullName && getInitials(selectedChat.contact?.fullName)}
                      </CustomAvatar>
                    )}
                  </Badge>
            ...
            {selectedChat && userProfile ? (
              <ChatLog hidden={hidden} store={store} checkMsg={checkMsg} data={{ ...selectedChat, userContact: userProfile.user }} />
            ) : null}
