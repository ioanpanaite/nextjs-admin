          ...
          <Box sx={{ position: 'relative' }}>
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', p: theme => theme.spacing(11.25, 6, 4.5) }}>
              <Box sx={{ mb: 3.5, display: 'flex', justifyContent: 'center' }}>
                ...
                >
                  {store.selectedChat.contact?.image ? (
                    <MuiAvatar
                      sx={{ width: '5rem', height: '5rem' }}
                      src={store.selectedChat.contact?.image}
                    ...
                    >
                      {store.selectedChat.contact?.fullName && getInitials(store.selectedChat.contact?.fullName)}
                    </CustomAvatar>
                  )}
                </Badge>
              </Box>
                  ...
                  <List dense sx={{ p: 0 }}>
                    <ListItem sx={{ px: 2 }}>
                      ...
                      <ListItemText
                        ...
                        primary={store.selectedChat.contact?.email}
                      />
                    </ListItem>
                    <ListItem sx={{ px: 2 }}>
                      <ListItemIcon sx={{ mr: 2 }}>
