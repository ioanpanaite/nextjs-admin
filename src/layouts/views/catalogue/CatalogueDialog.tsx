...
import { deleteCatalogue } from 'src/store/apps/catalogue'
...
const CatalogueDialog = (props: Props) => {
  // ** Props
  ...
  return (
    <>
      <Dialog fullWidth open={open} onClose={handleClose} sx={{ '& .MuiPaper-root': { width: '100%', maxWidth: 512 } }}>
        ...
        >
          ...
          >
            ...
            <Typography variant='h4' sx={{ mb: 5, color: 'text.secondary' }}>
              Are you sure to delete catalogue?
            </Typography>
        ...
        >
          <Button variant='contained' sx={{ mr: 2 }} onClick={handleDeleteConfirm}>
      ...
      >
        <DialogContent>
          ...
          >
            ...
            <Typography>{userInput === 'yes' ? 'Catalogue has been deleted.' : 'Cancelled catalgoue :)'}</Typography>
          </Box>
        </DialogContent>
